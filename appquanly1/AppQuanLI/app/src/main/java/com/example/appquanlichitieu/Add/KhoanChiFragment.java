...
public class KhoanChiFragment extends Fragment implements DatePickerDialog.OnDateSetListener {
    ...
    View view;
    Button btnThemDanhMuc, btnHuyThem,themKhoanChi;
    EditText edtThemDanhMuc , edtGhiChu, edtKhoanChi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtKhoanChi = view.findViewById(R.id.edtKhoanChi);
...
// Thiết lập adapter cho listView
    ...
    public GiaoDich layDuLieuGiaoDich(){
        ...
        String amountStr = edtKhoanChi.getText().toString();
